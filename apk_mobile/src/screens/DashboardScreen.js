...
import { fmtKwh, fmtPct, fmtPctNum, fmtDate } from '../utils/format';
...
export default function DashboardScreen() {
  ...
  return (
    <View style={[s.root, { backgroundColor: theme.bgPrimary }]}>
      ...
      >
        {/* Status bar */}
        <View style={[s.statusBar, { backgroundColor: theme.bgCard, borderColor: theme.border }]}>
...
const s = StyleSheet.create({
  ...
  statusBar:{ flexDirection:'row', alignItems:'center', padding:10, borderRadius:12, borderWidth:1, marginBottom:14 },
