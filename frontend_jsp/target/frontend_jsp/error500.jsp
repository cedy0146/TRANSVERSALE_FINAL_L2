...
<div class="app-layout">
  <main class="main-content" style="max-width:920px;margin:0 auto;padding:24px;">
    <div class="card" style="padding:24px;">
      ...
      <p style="color:var(--c-text-3);margin:0 0 16px 0;">
      ...
      <div class="grid-2" style="grid-template-columns:1fr;">
        <div>
          ...
          <pre style="white-space:pre-wrap;word-break:break-word;background:var(--c-surface-2);padding:12px;border-radius:var(--radius-sm);border:1px solid var(--c-border);">
